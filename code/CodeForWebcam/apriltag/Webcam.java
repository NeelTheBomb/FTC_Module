...
@TeleOp
public class DocumentedWebcam extends LinearOpMode {
  ...
  public static class CamPipeline extends OpenCvPipeline {
    //enum for position
    ...
    private volatile BotPosition position = BotPosition.LEFT;
    ...
    */
    ...
    public BotPosition getAnalysis() {
      return position;
    }
  }
}
